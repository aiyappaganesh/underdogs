config = {
    'client_id': '0b395df1e2d3db92f227c491bec2f382',
    ...
    'redirect_url': 'http://www.hirepirates.com/users/data/angellist/update_success'
}
...
profile_config = {
    ...
    'auth_url': 'https://angel.co/api/oauth/authorize',
    'token_url': 'https://angel.co/api/oauth/token',
    'redirect_url': 'http://www.hirepirates.com/users/profile/angellist/update_success'
}
