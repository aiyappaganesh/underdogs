...
class ProjectListPage(WebRequestHandler):
    def make_json(self, projects):
        return [{'id':project.id, 'title': project.title, 'description': project.description, 'skills': project.skills, 'bid': project.bid, 'end_date': project.end_date, 'image': project.image, 'company': project.company} for project in projects]
